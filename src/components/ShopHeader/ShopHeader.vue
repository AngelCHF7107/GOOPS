        ...
        <div class="mask-wrapper">
          <div class="mask-main">
            ...
            <ul class="list">
              ...
              <!--<li><span class="iocn discount"></span> <span>在线支付满50减25</span></li>
              <li><span class="iocn guarantee"></span> <span>单人精彩套餐</span></li>
              <li><span class="iocn invoice"></span> <span>该商家支持发票,请下单写好发票抬头</span></li>
              <li><span class="iocn special"></span> <span>已加入“外卖保”计划,食品安全保障</span></li>-->
            </ul>
            <div class="info">
              <div class="line"></div>
